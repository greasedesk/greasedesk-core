...
const TIERS = {
  ...
  core: [
    ...
    'demo-fuel-gate', 'demo-generation-gate', 'demo-lifecycle-gate', 'demo-profile-gate',
  ...
  slow: [
    'battery-gate', 'closure-kind-gate', 'condition-visibility-gate', 'consent-reach-gate', 'intake-offer-gate',
