...
This draft describes GreaseDesk's actual data practices as far as they are known from the product itself. Every place requiring a fact that only GreaseDesk Ltd can confirm is marked **`[YOU SUPPLY: …]`**. Do not publish until every such gap is filled and the whole document has been reviewed by someone qualified to check UK data-protection compliance. The clauses on international transfers, lawful basis, retention, and the controller/processor split carry real regulatory weight and are the ones most worth a professional eye.

**Policy version:** 2026-07-21 (revision 3)
**Last updated:** `[YOU SUPPLY: date of publication]`
...
2. [The two roles we play](#2-the-two-roles-we-play)
3. [What personal data we collect](#3-what-personal-data-we-collect)
4. [How we collect it](#4-how-we-collect-it)
5. [Why we process your data, and our lawful basis](#5-why-we-process-your-data-and-our-lawful-basis)
6. [Who we share your data with](#6-who-we-share-your-data-with)
...
11. [How we protect your data](#11-how-we-protect-your-data)
12. [Links to other websites](#12-links-to-other-websites)
...
- **ICO registration number:** `[YOU SUPPLY: your ICO Data Protection registration number — see note below]`
- **Contact for privacy matters:** dataprotection@greasedesk.com

> **Note on ICO registration:** Almost all UK organisations that process personal data electronically must register with the Information Commissioner's Office and pay the annual data-protection fee. GreaseDesk's processing (customer, tenant and reseller data across multiple businesses) requires registration. Confirm your position using the ICO's self-assessment at ico.org.uk, register if required, and insert the registration number above. Do not publish this policy stating a registration you do not hold.
...
For this processor data, the garage decides what is collected and why; we only process it to provide the service. If you are a customer of a garage that uses GreaseDesk and you wish to exercise your data-protection rights, your first point of contact is **the garage**, as controller. We will support the garage in responding to your request.

The relationship between GreaseDesk and each tenant for this processing is governed by a Data Processing Agreement. `[YOU SUPPLY: confirm a DPA exists / is incorporated into your terms of service, and reference it here. A B2B SaaS handling customers' customer-data needs a DPA in place with tenants — this is separate from this public policy.]`
...
- Name, business or round, area covered, email, phone number, and any information provided in a reseller application.
...
- **From tenants** — garage-customer data reaches us because a tenant enters it into the service.
...
_Confirmed by GreaseDesk Ltd; subject to final review._

| Purpose | Whose data | Likely lawful basis |
|---|---|---|
| Providing and operating the GreaseDesk service to a tenant | Tenant users | Performance of a contract |
| Processing garage-customer data to deliver the service | Garage customers | We process on the tenant's instructions; the tenant relies on its own lawful basis as controller |
| Managing reseller applications, attribution and commission | Resellers | Performance of a contract / legitimate interests |
| Sharing tenant contact details and account status with the introducing reseller | Tenant users | Legitimate interests (operating our reseller programme and paying commission accurately) |
| Responding to enquiries and providing support | Enquirers, tenants | Legitimate interests |
| Taking payment and managing subscriptions | Tenants | Performance of a contract |
| Securing our systems and preventing misuse | All | Legitimate interests |
| Analytics and marketing cookies | Visitors | Consent |
| Sending service and account communications | Tenants, resellers | Performance of a contract / legitimate interests |
| Marketing communications | We do not currently send marketing email | n/a |
...
|---|---|---|
| Vercel | Application hosting and delivery | London, UK (lhr1) |
| Neon | Database hosting | `[CONFIRM: check Neon dashboard — believed London/EU]` |
| Stripe | Payment processing | US / global |
| Resend | Transactional email delivery | US |
| Cloudflare R2 | File and image storage | `[CONFIRM: check Cloudflare R2 bucket jurisdiction]` |
| Google | Website analytics | US — **only if/when analytics is enabled and only with consent** |

This list is complete. We use no error-monitoring, support-desk or email-marketing tools that process personal data.
...
Some of our sub-processors are based outside the UK, including in the United States. Where personal data is transferred outside the UK, we ensure an appropriate safeguard is in place so it remains protected to UK standards.

`[YOU SUPPLY: state the actual safeguard you rely on for US transfers. The standard mechanisms are the UK International Data Transfer Agreement (IDTA), the UK Addendum to the EU Standard Contractual Clauses, or the provider's certification under the UK Extension to the EU–US Data Privacy Framework. Most of these providers (Vercel, Stripe, Resend, Cloudflare, Google) offer one of these in their data-processing terms — but you must confirm you have accepted/relied on it for each, and name the mechanism here. Do not claim a safeguard you have not put in place.]`

You can ask us for more information about these transfers and safeguards.
...
- **Garage-customer data** — retained while the tenant's account is active and subject to the tenant's own retention decisions as controller; deleted or returned per the Data Processing Agreement on account closure. On account closure the garage may extract its data; it is then **deleted after 90 days**.
...
- **Enquiry data** — **12 months** after the enquiry is resolved.
...
### If you are a customer of a garage
...
- Access controls that limit data to those who need it, with separate, isolated access for administrative functions.
- Secret-scanning and other safeguards in our development process to prevent accidental exposure of credentials.
...
- **Multi-factor authentication** is available and in use on administrative accounts.
- **Role-based access control**, enforced server-side, limits what each user can see and do — including region-scoped restrictions for administrative staff.
- **Audit logging** records privileged actions, including changes to accounts, permissions and financial records.
- **Secret scanning** runs automatically in our development pipeline to prevent credentials being exposed.
- Our database provider maintains automated backups with point-in-time recovery.

No system is perfectly secure, but we work to protect your data and to respond quickly if something goes wrong. `[OUTSTANDING: breach-notification process not yet documented — see gaps below.]`
...
We may update this policy from time to time. The version and date at the top show when it was last changed. Where changes are significant, we will take reasonable steps to bring them to your attention.
