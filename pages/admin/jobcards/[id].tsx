  ...
  return (
    <>
      ...
      <JobCardWorkspace
        ...
        canIssueInvoice={props.canIssueInvoice}
        ...
        acceptanceNote={props.acceptanceNote}
        acceptanceLabel={props.acceptanceLabel}
        agreedVersionFix={props.agreedVersionFix}
