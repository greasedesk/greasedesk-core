...
const TIERS = {
  ...
  core: [
    'date-constant-gate', 'purge-completeness-gate', 'client-bundle-gate', 'gate-origin-gate', 'anchored-match-gate', 'contact-preferences-gate', 'carrier-stop-gate', 'marketing-optout-gate',
    'schema-drift-gate',
    'rep-host-gate',
