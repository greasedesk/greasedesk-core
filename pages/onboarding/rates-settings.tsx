...
export default function RatesSettingsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Basic validation
    if (!data.defaultLabourRate || !data.currencyCode) {
    ...
    <div className="min-h-screen bg-slate-900 text-white p-4 sm:p-8">
      ...
      <div className="max-w-lg mx-auto bg-slate-800 p-6 sm:p-8 rounded-xl shadow-2xl border border-blue-600/50">
        ...
        <p className="text-slate-400 mb-6">
          Set your currency, timezone and default labour rate. VAT/tax is the next step.
        </p>
...
// Wizard step-guard (item-13): reachable only as the current incomplete step.
