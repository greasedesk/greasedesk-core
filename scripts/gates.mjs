...
const TIERS = {
  ...
  core: [
    ...
    'mot-sweep-stamp-gate', 'enum-drift-gate', 'tax-display-gate', 'printed-countdown-gate', 'invoice-blocks-gate', 'quote-lead-gate', 'quote-drafts-gate', 'costbase-clip-gate', 'retry-transient-gate', 'wage-per-month-gate', 'costs-gate',
  ],
  /**
